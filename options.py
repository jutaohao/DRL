...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='cifar10', help='folder | cifar10 | mnist |FashionMNIST ')
        ...
        self.parser.add_argument('--nz', type=int, default=5, help='size of the latent z vector')
        ...
        self.parser.add_argument('--model', type=str, default='drlmodel', help='chooses which model to use.')
        ...
        self.parser.add_argument('--normal_class', default='horse', help='normal class idx for mnist and cifar datasets')
        self.parser.add_argument('--novel_class', default='Protocol2', help='normal class idx for mnist,fmnist and cifar datasets')
        ...
        self.parser.add_argument('--w_adv', type=float, default=50, help='Weight for adversarial loss. default=0.5')
        self.parser.add_argument('--w_feat', type=float, default=1, help='Weight for feature loss. default=1')
